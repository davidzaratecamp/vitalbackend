...
const COBERTURA_POR_PRODUCTOR = {
  'Luis Vitier': {
    ...
    'Carolina del Norte': ['Oscar', 'Ambetter', 'UHC', 'CareSource', 'BCBS'],
    'Carolina del Sur': ['Ambetter', 'UHC'],
  ...
  'Jessica Trujillo': {
    ...
    'Carolina del Norte': ['Ambetter', 'Oscar'],
    'Carolina del Sur': ['Molina', 'Ambetter'],
  ...
  'Talia Bordon': {
    ...
    'Carolina del Norte': ['Ambetter', 'UHC', 'Cigna', 'Oscar'],
    'Carolina del Sur': ['Molina', 'Ambetter', 'Cigna'],
    Florida: ['Molina', 'Ambetter', 'UHC', 'Cigna', 'Oscar'],
  },
  'Samuel Payne': {
    Texas: ['Molina', 'Ambetter', 'UHC', 'Oscar'],
    Georgia: ['Ambetter', 'UHC', 'Oscar', 'CareSource'],
    'Carolina del Norte': ['Ambetter', 'UHC', 'Oscar'],
    'Carolina del Sur': ['Molina', 'Ambetter'],
